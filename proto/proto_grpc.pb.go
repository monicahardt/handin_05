...
func (c *auctionClient) Bid(ctx context.Context, in *Amount, opts ...grpc.CallOption) (*Ack, error) {
	out := new(Ack)
	err := c.cc.Invoke(ctx, "/Handin_05.Auction/Bid", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *auctionClient) Result(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Amount, error) {
	out := new(Amount)
	err := c.cc.Invoke(ctx, "/Handin_05.Auction/Result", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuctionServer) Result(context.Context, *Empty) (*Amount, error) {
...
func _Auction_Bid_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Handin_05.Auction/Bid",
	}
...
func _Auction_Result_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Handin_05.Auction/Result",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
